# sensor_picoA.py  –  Sensor Pico, Building E2
#
# Dual role:
...
#   Classroom 1 (closest to head node) → "E2-02-01"
#   Classroom 2                         → "E2-02-02"
#   Classroom 3 (furthest)              → "E2-02-03"
ROOM_ID   = "E2-02-01"
...
class SensorNode:
    ...
    def inject_heatmap(self, scores):
        ...
        # Worst-case frame: M1|abc123|4095|3|H|2201:FF = 26 chars ✓
        self._msgid_ctr = (self._msgid_ctr + 1) & 0xFFF
