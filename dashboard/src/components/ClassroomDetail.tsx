...
import { predictOccupancy, generateForecast } from "../lib/prediction";
            ...
            <div className="mb-4 rounded-lg border border-red-200 bg-red-50 p-3 text-sm text-red-700">
              ...
              {error.includes("index") && (
                <p className="mt-2 text-xs text-red-600">
                  This query requires a Firestore composite index. Check the
                  browser console for a direct link to create it.
                </p>
              )}
            </div>
          )}
